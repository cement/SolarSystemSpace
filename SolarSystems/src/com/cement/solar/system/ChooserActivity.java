...
public class ChooserActivity extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String path = intent.getStringExtra("com.cement.solarsystem");

		if (path == null) {
			path = "";
		}
		List<Map<String, Object>> listData = getListData(path);
		setListAdapter(new SimpleAdapter(this, listData, android.R.layout.simple_list_item_1, new String[] { "title" },
				new int[] { android.R.id.text1 }));
		getListView().setTextFilterEnabled(true);
	}

	protected List<Map<String, Object>> getListData(String prefix) {
		List<Map<String, Object>> myData = new ArrayList<Map<String, Object>>();

		Intent mainIntent = new Intent(Intent.ACTION_MAIN, null);
		// mainIntent.addCategory(Intent.CATEGORY_SAMPLE_CODE);
		mainIntent.addCategory("com.cement.solarsystems");
	...
	protected Intent browseIntent(String path) {
		Intent result = new Intent();
		result.setClass(this, ChooserActivity.class);
		result.putExtra("com.cement.solarsystem", path);
		return result;
	}
